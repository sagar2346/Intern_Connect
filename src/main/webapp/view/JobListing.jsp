...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/JobListing.css">
...
<section class="job-section">
    ...
    <div class="job-grid">
        ...
        <div class="job-box">
            <img src="../assets/img/java.png" alt="Java Developer" class="job-img">
        ...
        <div class="job-box">
            <img src="../assets/img/python.png" alt="Python Developer" class="job-img">
            <p class="job-type">Onsite</p>
        ...
        <div class="job-box">
            <img src="../assets/img/marketing.png" alt="Marketing Manager" class="job-img">
            <p class="job-type">Onsite</p>
        ...
        <div class="job-box">
            <img src="../assets/img/hiring.png" alt="Hiring Manager" class="job-img">
            <p class="job-type">Onsite</p>
        ...
        <div class="job-box">
            <img src="../assets/img/security.png" alt="Security Analyst" class="job-img">
        ...
        <div class="job-box">
            <img src="../assets/img/soc.png" alt="Soc Analyst" class="job-img">
            <p class="job-type">Remote</p>
            <h3>Soc Analyst</h3>
