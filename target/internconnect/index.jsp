    ...
    <nav class="nav-links">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="${pageContext.request.contextPath}/view/EmployeeZoneLogin.jsp">Employee Zone</a>
                <a href="${pageContext.request.contextPath}/view/AdminLogin.jsp">Admin Zone</a>
            </div>
        </div>
        <div class="dropdown">
