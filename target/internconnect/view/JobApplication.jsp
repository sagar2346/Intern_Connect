...
<div class="navbar">
    ...
    <nav class="nav-links">
        <a href="${pageContext.request.contextPath}/view/index.jsp" class="active">Home</a>
    </nav>
</div>
...
<div class="form-container">
    ...
    <form action="${pageContext.request.contextPath}/submitApplication.jsp" method="post" enctype="multipart/form-data">
